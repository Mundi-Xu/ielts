  ...
  <div class="px-4 pt-6 2xl:px-0">
    ...
    >
      ...
      >
        <li class="w-full">
          <button
            type="button" :class="activeTab === 'translation' ? 'inline-block w-full p-4 text-gray-900 bg-gray-100 border-r border-gray-200 dark:border-gray-700 rounded-s-lg focus:ring-4 focus:ring-blue-300 active focus:outline-none dark:bg-gray-700 dark:text-white'
        ...
        <li class="w-full">
          <button
            type="button" :class="activeTab === 'task1' ? 'inline-block w-full p-4 text-gray-900 bg-gray-100 border-r border-gray-200 dark:border-gray-700 focus:ring-4 focus:ring-blue-300 active focus:outline-none dark:bg-gray-700 dark:text-white'
              : 'inline-block w-full p-4 bg-white border-r border-gray-200 dark:border-gray-700 hover:text-gray-700 hover:bg-gray-50 focus:ring-4 focus:ring-blue-300 focus:outline-none dark:hover:text-white dark:bg-gray-800 dark:hover:bg-gray-700'"
        ...
        <li class="w-full">
          <button
            type="button" :class="activeTab === 'task2' ? 'inline-block w-full p-4 text-gray-900 bg-gray-100 border-r border-gray-200 dark:border-gray-700 rounded-e-lg focus:ring-4 focus:ring-blue-300 active focus:outline-none dark:bg-gray-700 dark:text-white'
              : 'inline-block w-full p-4 bg-white border-r border-gray-200 dark:border-gray-700 hover:text-gray-700 hover:bg-gray-50 focus:ring-4 focus:ring-blue-300 focus:outline-none dark:hover:text-white dark:bg-gray-800 dark:hover:bg-gray-700 rounded-e-lg'"
            @click="activeTab = 'task2'"
          >
            雅思大作文
          </button>
        </li>
                    ...
                    <template v-for="item of sentences" :key="item.no">
                      <template v-if="item.no == null">
                        <tr class="border-t-1 border-x-1">
                          <td colspan="5" class="p-4 font-bold text-xl">
                            {{ item.title }}
                          </td>
                        </tr>
                      </template>
                      <template v-else>
                        <tr class="border-t-1">
                          ...
                          <td class="p-4 border-b-1 flex items-center">
                            <div class="mr-4" title="来自书上标准答案">
                              <i class="i-carbon-book block" />
                            </div>
                        ...
                        <tr>
                          <td class="p-4 flex items-center">
                            <div class="mr-4" title="来自 ChatGPT">
                              <i class="i-simple-icons-openai block" />
                            </div>
        ...
        <div v-else>
          ...
          <div class="mb-6 p-4 bg-yellow-50 rounded-lg dark:bg-yellow-900 dark:bg-opacity-20">
            ...
            <ul class="list-disc pl-5 space-y-1 dark:text-gray-300">
              <li v-for="(tip, index) in selectedPrompt.tips" :key="index">
                {{ tip }}
              </li>
            </ul>
          </div>
